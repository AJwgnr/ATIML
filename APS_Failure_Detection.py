...
imp.fit(dataFrameWithoutlable)
ImputedDataFrame=pd.DataFrame(imp.transform(dataFrameWithoutlable))
...
standardData = scaler.fit_transform(ImputedDataFrame)
print(standardData)
print('\n')


#Performing PCA on standardized data and reducing the dimension from 170 to top 10 principal components
pca = PCA(n_components=10)
principalComponents = pca.fit_transform(standardData)
...
print('\n')
print('Top 10 principal components are:')
print(principalDf)

#Adding the class lables with the reduced feature space and making a final dataset for modeling
finalDf = pd.concat([principalDf, df[['class']]], axis = 1)

print('\n')
print('The final Dataset with class lables and reduced feature set of 10:')
print(finalDf)
print('\n')
print('******Conterting DataFrame Into CSV******')
